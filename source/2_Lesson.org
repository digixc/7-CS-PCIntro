...
- Your *home drive* can be accessed by one of the following ways:
  ...
  3. Method 3: from the Start menu, then the magifier glass symbol, type *H:* in the search bar.
...
6. After you have followed the above steps you should have something like this:
`
